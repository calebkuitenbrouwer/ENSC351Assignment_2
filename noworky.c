...
void tradeArrays(double *array1, double *array2, int size)
{
	unsigned int i;
	for (i = size-1; i > 0; i--) { 
		//Bug was here: The loop condition i >= 0 caused an underflow when i became - due to unsigned integer behavior. 
		//Removed the 'or equal' condition and now the code runs correctly. 
